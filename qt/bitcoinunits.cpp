...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("TBCC");
    case mBTC: return QString("mTBCC");
    case uBTC: return QString::fromUtf8("μTBCC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("TBCCs"));
    case mBTC: return QString(QObject::tr("Milli-TBCCs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-TBCCs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
