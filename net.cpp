...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("ThousandBitcoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("ThousandBitcoin-net");
...
static const char *strDNSSeed[][2] = {
    {"165.227.220.4", "165.227.220.4"},
	{"165.227.215.109", "165.227.215.109"}
};
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("ThousandBitcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("ThousandBitcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("ThousandBitcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("ThousandBitcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ThousandBitcoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("ThousandBitcoin-start");
